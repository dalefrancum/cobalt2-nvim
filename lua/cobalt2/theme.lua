...
Group.new("Cursor", colors.light_grey, colors.cobalt_bg, nil)
Group.new("CursorColumn", nil, colors.cursor_hover, nil)
Group.new("CursorIM", colors.light_grey, colors.cobalt_bg, nil)
Group.new("CursorLine", nil, colors.cursor_line, nil)
Group.new("CursorLineNr", colors.light_grey, nil, styles.bold)
Group.new("DiffAdd", colors.white, colors.dirty_green:dark(), nil)
Group.new("DiffChange", colors.white, colors.dirty_green:dark(), nil)
Group.new("DiffDelete", colors.white, colors.dark_red, nil)
...
Group.new("FloatTitle", colors.light_grey, colors.darker_blue, nil)
...
Group.new("IncSearch", colors.black, colors.light_grey, styles.NONE)
...
Group.new("NormalMode", colors.black, colors.light_grey, nil)
...
Group.new("PMenuSel", colors.black, colors.light_grey, nil)
Group.new("PMenuThumb", nil, colors.lightest_grey, nil)
Group.new("Question", colors.green, nil, nil)
Group.new("QuickFixLine", colors.light_grey, colors.cursor_hover, nil)
...
Group.new("StatusLine", colors.light_grey, colors.cursor_line, nil)
Group.new("StatusLineNC", colors.white, colors.cursor_line, nil)
Group.new("TabLine", colors.light_grey, colors.cursor_hover, nil)
...
Group.new("WarningMsg", colors.light_grey, nil, nil)
Group.new("Warnings", colors.light_grey, nil, nil)
Group.new("Whitespace", colors.dark_grey, nil, nil)
Group.new("WildMenu", colors.blue, colors.light_grey, nil)
Group.new("WinBar", colors.light_grey, nil, nil)
